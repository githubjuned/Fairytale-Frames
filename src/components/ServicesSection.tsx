...
export const ServicesSection: React.FC<ServicesSectionProps> = ({ onOpenInquiry }) => {
  ...
  return (
    <section id="services" className="py-12 sm:py-20 md:py-28 bg-white text-black relative overflow-hidden">
            ...
            >
              ...
              <div className="absolute top-0 left-1/2 -translate-x-1/2 z-20 pointer-events-none w-full text-center px-2">
                <motion.h3 
                  ...
                  className="font-cormorant italic font-normal text-4xl sm:text-6xl md:text-6xl lg:text-7xl text-black tracking-tight drop-shadow-[0_2px_12px_rgba(255,255,255,0.9)] group-hover:-translate-y-2 group-hover:scale-105 transition-all duration-500"
                >
                  {service.title}
                </motion.h3>
              </div>
              ...
              <motion.div 
                ...
                className="relative w-full aspect-square overflow-hidden bg-neutral-100 border border-black/10 shadow-lg rounded-sm group-hover:border-[#D4AF37] transition-colors duration-500"
              >
                <img
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-b from-black/20 via-transparent to-black/10 opacity-40 group-hover:opacity-10 transition-opacity duration-500" />
              </motion.div>
              ...
              <div className="mt-4 sm:mt-5 flex items-center justify-between px-1">
                <motion.span 
                  ...
                  className="font-cormorant italic font-normal text-lg sm:text-2xl text-black tracking-wide group-hover:text-[#B8860B] transition-colors"
                >
                  Know More
                </motion.span>
                ...
                <motion.div 
                  ...
                  className="w-9 h-9 sm:w-12 sm:h-12 rounded-full bg-[#D4AF37] text-black flex items-center justify-center transition-all duration-300 group-hover:bg-[#B8860B] group-hover:text-white shadow-sm"
                >
